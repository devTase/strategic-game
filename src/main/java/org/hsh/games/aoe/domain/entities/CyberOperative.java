...
public class CyberOperative extends Consumer<ResourceAmount> {
    ...
    public void makeConstruction(ConstructionProcessType process, Building building, List<ResourceAmount> playerResources, List<CyberOperative> operativeList) {
        currentMission = process.getProcess() + " de Edifício: " + building.getConstructionTypeName();
        Thread constructionThread = process == ConstructionProcessType.CREATION
