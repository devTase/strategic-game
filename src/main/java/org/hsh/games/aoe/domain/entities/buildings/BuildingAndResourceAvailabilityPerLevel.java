...
public enum BuildingAndResourceAvailabilityPerLevel {
    LEVEL_1(1, List.of(
            ...
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(1)
    ),
    LEVEL_2(2,
            List.of(
                    ConstructionType.TRAINING_FACILITY,
                    ConstructionType.WEAPONS_RANGE
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(2)
    ),
    LEVEL_3(3,
            List.of(
                    ConstructionType.VEHICLE_BAY,
                    ConstructionType.TRADE_HUB
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(3)
    ),
    LEVEL_4(4,
            List.of(
                    ConstructionType.TECH_FOUNDRY,
                    ConstructionType.SUPPLY_STATION
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(4)
    ),
    LEVEL_5(5,
            List.of(
                    ConstructionType.CRYPTO_MINE,
                    ConstructionType.LAUNCH_PAD
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(5)
    ),
    LEVEL_6(6,
            List.of(
                    ConstructionType.COMM_RELAY,
                    ConstructionType.NEURAL_NEXUS
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(6)
    ),
    LEVEL_7(7,
            List.of(
                    ConstructionType.RESEARCH_LAB
            ), ResourceType.getResourcesPackBasedOnCurrentPhase(7)
    ),
    LEVEL_8(8, new ArrayList<>(), ResourceType.getResourcesPackBasedOnCurrentPhase(8)),
    LEVEL_9(9, new ArrayList<>(), ResourceType.getResourcesPackBasedOnCurrentPhase(9)),
    ;
